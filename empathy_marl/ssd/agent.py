"""Agents of the Sequential Social Dilemma games: position, orientation, view and reward bookkeeping.

Vendored from https://github.com/011235813/sequential_social_dilemma_games (MIT licence, see LICENSE
and NOTICE in this directory).  Changes: no gym dependency (the spaces are declared by the PettingZoo
wrapper), the view helper comes from :mod:`empathy_marl.ssd.utility`, the Harvest agent is dropped.
"""
import numpy as np

from empathy_marl.ssd import utility as util
...
class CleanupAgent(Agent):
    ...
    num_actions = 9  # BASE_ACTIONS + FIRE + CLEAN (the wrapper exposes a subset)
